<!-- Modal -->
<div class="modal fade" id="modal_input_barang_masuk_hardware{{ $data_barang->id_bast }}" tabindex="-1" role="dialog"
    aria-labelledby="modal_input_barang_masuk_hardware_label" aria-hidden="true">
    <div class="modal-dialog" role="document" id="signature-pad">
        <div class="modal-content" id="signature-pad2">
            <div class="modal-header">
                <h5 class="modal-title" id="modal_input_barang_masuk_hardware_label">Form BAST</h5>
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <label class="form-check-label text-justify" for="konfirmasi_data">
                                    ...
                                    kepada Pihak Kedua untuk keperluan pengecekan hardware dan menerima seluruh tindakan
                                    yang akan dilakukan terkait pengecekan tersebut.
                                </label>
                            </div>
                        </div>
...
<script>
    $(function() {
        ...
        $('#modal_input_barang_masuk_hardware{{ $data_barang->id_permintaan }}').on('hidden.bs.modal',
        function() {
