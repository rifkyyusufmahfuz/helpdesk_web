                    ...
                    <div class="row card-body">
                        <div class="col-md-7">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-5">
                                    ...
                                    <input type="text" class="form-control" placeholder="NIPP" maxlength="5" />
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-5">
                                    ...
                                    <input type="text" class="form-control" placeholder="Unit/Bagian" />
                                </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" minlength="10" maxlength="10" name="txtEmpPhone" class="form-control"
                                    placeholder="Email..." />
                            </div>
