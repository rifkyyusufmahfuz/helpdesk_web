@foreach ($permintaan as $data)
    ...
    <div class="modal fade" id="validasi_rekomendasi_{{ $data->id_permintaan }}" tabindex="-1" role="dialog"
        aria-labelledby="validasi_rekomendasi_label" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="signature_pad_manager_{{ $data->id_permintaan }}">
                    <form action="/manager/crud/{{ $data->id_permintaan }}" method="POST"
                        ...
                        @csrf
                        @method('PUT')
                        <input hidden id="divalidasi" name="divalidasi">
                            ...
                            <tbody>
                                ...
                                @foreach ($list_hardware->where('id_permintaan', $data->id_permintaan) as $data2)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $data2->problem }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
                        ...
                        <div class="form-group text-center">
                            <label for="catatan_manager_{{ $data->id_permintaan }}">Rekomendasi hasil
                                pengecekan</label>
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <label class="form-check-label text-justify"
                                    ...
                                    Validasi rekomendasi hasil pengecekan hardware dengan
                                    Nomor Permintaan "<b>{{ $data->id_permintaan }}</b>" dan akan menyelesaikan proses
                                    tersebut.
                                </label>
                            </div>
                        </div>
